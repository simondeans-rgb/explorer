      ...
      <DestinationImage code={HERO_CODES.story[0]} codes={HERO_CODES.story} scrim motion style={{ flex: 1 }}>
        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
          ...
          >
            ...
            {/* Form card */}
            <View className="rounded-3xl" style={{ backgroundColor: COLORS.card, padding: 18, shadowColor: '#14213D', shadowOpacity: 0.18, shadowRadius: 16, shadowOffset: { width: 0, height: 8 } }}>
              {mode === 'up' ? (
                <Field>
                  <TextInput
                    value={name}
