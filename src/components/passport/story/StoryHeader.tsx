 ...
 * Full-bleed destination photography under a sunset gradient, with an organic
 * wave edge that melts into the content below. Personal greeting, an aspirational
 * headline, a search pill and a handwritten flourish.
 */
export function StoryHeader({
  ...
  return (
    <div className="relative -mx-4 sm:-mx-6">
      <DestinationImage code={heroCode} className="min-h-[480px]">
        <div className="relative flex min-h-[480px] h-full flex-col">
          ...
          <div className="relative z-10 mt-auto px-6 pb-16">
            ...
            {/* Search pill — taps through to Explore */}
            <button
              type="button"
              onClick={onSearch}
